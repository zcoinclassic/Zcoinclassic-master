    ...
    tab(tab)
{
    ...
    {
    case SendingTab:
        ui->labelExplanation->setText(tr("These are your zcoinclassic addresses for sending payments. Always check the amount and the receiving address before sending coins."));
        ...
        break;
    case ReceivingTab:
        ui->labelExplanation->setText(tr("These are your zcoinclassic addresses for receiving payments. You may want to give a different one to each sender so you can keep track of who is paying you."));
        ...
        break;
    case ZerocoinTab:
        ui->labelExplanation->setText(tr("These are your private coins from mint zerocoin operation, You can perform spend zerocoin operation to redeem zcoinclassic back from Zerocoin."));
        ui->deleteAddress->setVisible(false);
        ui->signMessage->setVisible(false);
