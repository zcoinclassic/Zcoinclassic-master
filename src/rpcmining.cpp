...
Value getworkex(const Array& params, bool fHelp)
{
    ...
    if (vNodes.empty())
        throw JSONRPCError(RPC_CLIENT_NOT_CONNECTED, "zcoinclassic is not connected!");

    if (IsInitialBlockDownload())
        throw JSONRPCError(RPC_CLIENT_IN_INITIAL_DOWNLOAD, "zcoinclassic is downloading blocks...");
...
Value getblocktemplate(const Array& params, bool fHelp)
{
    ...
    BOOST_FOREACH (CTransaction& tx, pblock->vtx)
    {
        ...
        // https://github.com/zcoinclassicofficial/zcoinclassic/pull/26
...
Value getworkaux(const Array& params, bool fHelp)
{
    ...
    if (vNodes.empty())
        throw JSONRPCError(-9, "zcoinclassic is not connected!");

    if (IsInitialBlockDownload())
        throw JSONRPCError(-10, "zcoinclassic is downloading blocks...");
