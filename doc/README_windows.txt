...
Setup
-----
Unpack the files into a directory and run zcoinclassic-qt.exe.

zcoinclassic is the original zcoinclassic client and it builds the backbone of the network.
However, it downloads and stores the entire history of zcoinclassic transactions;
